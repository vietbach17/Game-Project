...
*   **`GameManager`**: Quản lý vòng đời trò chơi, quản lý thời gian ngày/đêm và điều phối các hệ thống con (với 2 Phase chính: `BeforeTheStorm` và `AfterTheStorm`).
*   **`PhaseManager`**: Quản lý trình tự 2 giai đoạn thiên tai và thời gian chuyển dịch giữa các ngày cốt truyện.
